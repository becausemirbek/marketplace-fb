        ...
        <div className="footer-img pt-5 pb-5 mb-5">
          <Container>
            <div className="d-lg-none">
              <p>доска объявлений для комфортного выбора</p>
            </div>
            ...
            <div className="d-none d-lg-block">
              ...
              <p>
                онлайн доска объявлений, с помощью которой поиск работы,
              ...
              <p>
                ...
                что делает незаменимой практически для любых случаев
              ...
              <p>
                Чтобы воспользоваться порталом. необходимо просто указать
